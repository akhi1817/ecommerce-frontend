...
const UploadProduct = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error during product upload:", error.response?.data || error.message);
            ...
            <form onSubmit={handleSubmit} className="overflow-y-scroll" style={{ height: '700px' }}>
              <div className="row ms-5">
                ...
                <div className="col-md-8 mt-5 text-center">
                  <button className="btn btn-success">Upload Product</button>
                </div>
              </div>
            </form>
          </div>
